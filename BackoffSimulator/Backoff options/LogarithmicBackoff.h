...
#ifndef BACKOFFSIMULATOR_LOGARITHMICBACKOFF_H
#define BACKOFFSIMULATOR_LOGARITHMICBACKOFF_H
...
class LogarithmicBackoff: public SimulationClass {
public:
    // CSTR % DSTR
    LogarithmicBackoff(long long, unsigned long long); // arguments: size of W, amount of nodes
    ~LogarithmicBackoff();
...
#endif //BACKOFFSIMULATOR_LOGARITHMICBACKOFF_H
