...
/***************CSTR & DSTR***********************/
BinaryExponentialBackoff::BinaryExponentialBackoff(long long size, unsigned long long amount) :
...
/***************GETTERS***********************/
unsigned long long BinaryExponentialBackoff::getAmountOfNodes()
{
    return amountOfNodes;
}

void BinaryExponentialBackoff::showNodes()
{
    for(auto i : nodes)
    {
...
long long BinaryExponentialBackoff::getRounds()
{
    return numberOfRounds;
}

unsigned int BinaryExponentialBackoff::countEnergyPoints()
{
    auto energyPoints = 0;
    for(auto i : nodes)
    {
...
unsigned long long BinaryExponentialBackoff::getRunningTime()
{
...
/***************SIMULATION FUNCT***********************/
void BinaryExponentialBackoff::startSimulation()
{
...
bool BinaryExponentialBackoff::checkNodes()
{
    for(auto i : nodes)
